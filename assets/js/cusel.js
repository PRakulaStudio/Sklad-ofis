...
function cuSel(params) {
		//					console.log(jQuery(params.changedEl));
	jQuery(params.changedEl).each(
	function(num)
	{//	alert(params.changedEl)
	//console.log(this);
...
/*Випадаюче меню форми*/
	var params = {
		changedEl: "#sort_search6",
		visRows: 4,
		scrollArrows: true
	}
	cuSel(params);
...
/*Випадаюче меню форми*/
	...
	cuSel(params);	
		...
		var params = {
		changedEl: "#sort_search2",
		refreshEl:"#sort_search2",
		scrollArrows: false,
		visRows: 10,
	}
	cuSel(params);		
		...
		var params = {
		changedEl: ".form_wrapper .cuselInit",
		refreshEl:".form_wrapper .cuselInit",
		scrollArrows: false,
		visRows: 10,
	}
	cuSel(params);		
